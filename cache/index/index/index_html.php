...
<body>
	...
	<div class="col-md-9 main">
		...
		<div class="banner-section">
		   <h3 class="tittle">概览 <i class="glyphicon glyphicon-picture"></i></h3>
			<div class="banner">
                 <div  class="callbacks_container">
					<ul class="rslides" id="slider4">
					       <li>
							...
							<li>
								 <img src="public/images/3.jpg" class="img-responsive" alt="" />
							...
							<li>
							 <img src="public/images/5.jpg" class="img-responsive" alt="" />
		 ...
		 <div class="clearfix"> </div>
			    <div class="b-bottom"> 
			      <h5 class="top"><a href="single.html">The list of all blogs</a></h5>
			  ...
			  <?php foreach($data as $value):?>
				<div class="top-inner">
					 ...
					 <div class="col-md-6 top-text">
						 <a href="http://localhost/blog/index.php?c=article&a=single&id=<?=$value['id'];?>"><img src="<?=$value['pic'];?>" class="img-responsive" alt=""></a>
				          <div class="ser">
						    <h5 class="top"><a href="http://localhost/blog/index.php?c=article&a=single&id=<?=$value['id'];?>"><?=$value['title'];?></a></h5>
							<p><?php echo mb_substr($value['content'],0,60)?>...</p>
						    <p><?php  echo date('F d',$value['addtime']) ?>, <?php  echo date('Y',$value['addtime']) ?> <a class="span_link" href="#"><span class="glyphicon glyphicon-comment"></span><?=$value['replycount'];?> </a><a class="span_link" href="#"><span class="glyphicon glyphicon-eye-open"></span><?=$value['hits'];?> </a><a class="span_link" href="single.html"><span class="glyphicon glyphicon-circle-arrow-right"></span></a></p>
					    </div>
					 </div>
				...
				<div class="yeshutiao">
					...
					<?php for($i=$offset;$i<=$max;$i++):?>
						<b><a href="http://localhost/blog/index.php?page=<?=$i;?>"><?=$i;?></a></b>
					<?php endfor;?>
